...
// STEP 2b: Determine how far down the top of the #floatingbar is from the top of the viewport and capture it with a var called navTop
let navTop = nav.offsetTop;
// STEP 4a: Get the 'Back to top' button from the DOM with a var topButton
const topButton = document.querySelector("footer p a.top");
// STEP 8a: Assign any and all elements with the class="pullquote" to the var pullQuote
...
// Setting a distance for showing the 'Back to top' button
const distanceToShow = 150;

// Modifying the event listener for the scroll event
window.addEventListener("scroll", function () {
    // Fixing the page jump issue
    document.body.style.paddingTop = nav.offsetHeight + "px";

    // Show the 'Back to top' button only after scrolling a certain distance
